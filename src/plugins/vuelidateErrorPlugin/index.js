...
function plugin(Vue, options = {}) {
  ...
  if (typeof options.template === "undefined") {
    console.error(
      "[vuelidate-message-extractor warn]: No template component provided in vuelidate-error-extractor options. Please provide a template using Vue.use(vuelidateMessageExtractor, { template: yourImportedType })"
    );
  } else {
